...
while run:
    player = pygame.image.load('sprites/Knight.png')
    ...
    for event in pygame.event.get():
        ...
        # Attacking
            ...
            if (event.key== ord('x')):
                ...
                print ("attack.")
                pygame.mixer.music.load('audio/sword_noise.mp3')
                pygame.mixer.music.play(0)
                player = pygame.image.load('sprites/Knight2.png')
    ...
    if level_one == True:
        bg = pygame.image.load("levels/level_1.png").convert()
        speech = pygame.image.load("images/speech3.png").convert()
    ...
    if level_two == True:
        bg = pygame.image.load("levels/level_2.png").convert()
        if x > 800 - vel - width:
            x = 50
            level_two = False
            level_three = True
    ...
    if level_three == True:
        bg = pygame.image.load("levels/level_3.png").convert()
        if x > 800 - vel - width:
            x = 50
            level_three = False
            level_four = True
    ...
    if level_four == True:
        bg = pygame.image.load("levels/level_4.png").convert()
        if x > 800 - vel - width:
            x = 50
            level_four = False
            level_five = True
